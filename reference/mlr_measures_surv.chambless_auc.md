...
Calls
[`survAUC::AUC.cd()`](https://fbertran.github.io/survAUC/reference/survAUC_ChamDiao.html).
...
Chambless LE, Diao G (2006). “Estimation of time-dependent area under
the ROC curve for long-term risk prediction.” *Statistics in Medicine*,
**25**(20), 3474–3486.
[doi:10.1002/sim.2299](https://doi.org/10.1002/sim.2299) .
...
- [`MeasureSurvChamblessAUC$new()`](#method-MeasureSurvChamblessAUC-new)

- [`MeasureSurvChamblessAUC$clone()`](#method-MeasureSurvChamblessAUC-clone)
