...
Calls
[`survAUC::spec.uno()`](https://fbertran.github.io/survAUC/reference/survAUC_Uno.html).
...
- [`MeasureSurvUnoTNR$new()`](#method-MeasureSurvUnoTNR-new)

- [`MeasureSurvUnoTNR$clone()`](#method-MeasureSurvUnoTNR-clone)
