...
The RMSE is defined by \$\$\sqrt{\frac{1}{n} \sum ((t - \hat{t})^2)}\$\$
where \\t\\ is the true value and \\\hat{t}\\ is the prediction.
...
- [`MeasureSurvRMSE$new()`](#method-MeasureSurvRMSE-new)

- [`MeasureSurvRMSE$clone()`](#method-MeasureSurvRMSE-clone)
