...
[whas](https://mlr3proba.mlr-org.com/reference/whas.md) data set.
...
- Features: “age”, “chf”, “cpk”, “lenstay”, “miord”, “mitype”, “sexF”,
  “sho”, “year”
...
- Column `sex` is renamed to `sexF`, `lenfol` to `time`, and `fstat` to
  `status`.
