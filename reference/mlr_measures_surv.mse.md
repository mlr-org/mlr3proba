...
The MSE is defined by \$\$\frac{1}{n} \sum ((t - \hat{t})^2)\$\$ where
\\t\\ is the true value and \\\hat{t}\\ is the prediction.
...
- [`MeasureSurvMSE$new()`](#method-MeasureSurvMSE-new)

- [`MeasureSurvMSE$clone()`](#method-MeasureSurvMSE-clone)
