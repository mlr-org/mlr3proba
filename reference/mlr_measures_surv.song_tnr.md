...
Calls
[`survAUC::spec.sh()`](https://fbertran.github.io/survAUC/reference/survAUC_SongZhou.html).
...
- [`MeasureSurvSongTNR$new()`](#method-MeasureSurvSongTNR-new)

- [`MeasureSurvSongTNR$clone()`](#method-MeasureSurvSongTNR-clone)
