...
Calls
[`survAUC::OXS()`](https://fbertran.github.io/survAUC/reference/R2_type_Coef.html).
...
O'Quigley J, Xu R, Stare J (2005). “Explained randomness in proportional
hazards models.” *Statistics in Medicine*, **24**(3), 479–489.
[doi:10.1002/sim.1946](https://doi.org/10.1002/sim.1946) .
...
- [`MeasureSurvOQuigleyR2$new()`](#method-MeasureSurvOQuigleyR2-new)

- [`MeasureSurvOQuigleyR2$clone()`](#method-MeasureSurvOQuigleyR2-clone)
