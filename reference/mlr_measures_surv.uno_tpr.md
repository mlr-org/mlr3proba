...
Calls
[`survAUC::sens.uno()`](https://fbertran.github.io/survAUC/reference/survAUC_Uno.html).
...
- [`MeasureSurvUnoTPR$new()`](#method-MeasureSurvUnoTPR-new)

- [`MeasureSurvUnoTPR$clone()`](#method-MeasureSurvUnoTPR-clone)
