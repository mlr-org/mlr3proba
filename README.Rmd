...
<!-- badges: start -->
[![R CMD Check via {tic}](https://github.com/mlr-org/mlr3proba/workflows/R%20CMD%20Check%20via%20{tic}/badge.svg?branch=master)](https://github.com/mlr-org/mlr3proba/actions)
...
* Improve estimation of integrated scores, and re-implement **[survAUC](https://CRAN.R-project.org/package=survAUC)** scores in **mlr3proba**
