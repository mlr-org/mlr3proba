...
c_weight_survival_score <- function(score, truth, unique_times, cens, proper = FALSE) {
    .Call('_mlr3proba_c_weight_survival_score', PACKAGE = 'mlr3proba', score, truth, unique_times, cens, proper)
}
