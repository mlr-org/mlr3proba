...
#'
#' # CIF list: 1 matrix per competing event, each matrix has dimentions
#' # (observations) x (times)
#' p$cif
#' @export
PredictionCompRisks = R6Class("PredictionCompRisks",
  ...
  public = list(
    ...
    #' to get all survival and hazard functions easily with interpolation.
    #' Think: store it in the `$data$distr` slot for internal use?
    #'
