...
#'
#' @description
#' Transform [PredictionClassif][mlr3::PredictionClassif] to [PredictionSurv]
#' using the **I**nverse **P**robability of **C**ensoring **W**eights (IPCW)
...
#' [data.table][data.table::data.table] containing observed times,
#' censoring indicators and row ids, all generated by [PipeOpTaskSurvClassifIPCW]
#' during the prediction phase.
#'
#' The output is the input [PredictionClassif][mlr3::PredictionClassif] transformed
#' to a [PredictionSurv].
