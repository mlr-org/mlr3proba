...
LearnerDensKDEsm <- R6::R6Class("LearnerDensKDEsm", inherit = LearnerDens,
  public = list(initialize = function(id = "dens.kdeSM"){
    super$initialize(
      id = id,
      param_set = ParamSet$new(
       ...
       #   ParamLgl$new(id = "add", default = TRUE, tags = "train")
          ...
          # ParamUty$new(id = "display", default = "none", tags = c("train", "predict")),
          ...
          # # ParamLgl$new(id = "hull", default = FALSE, tags = c("train", "predict")),
          ...
          # ParamLgl$new(id = "panel", default = FALSE,   tags = c("train", "predict")),
          # ParamLgl$new(id = "panel.plot", default = FALSE, tags = c("train", "predict")),
          ...
          # ParamLgl$new(id = "rugplot", default = FALSE, tags = c("train", "predict")),
   ...
   #       ParamLgl$new(id = "show.script", default = FALSE, tags = "train"),
    ...
    train_internal = function(task){
      ...
      sm::sm.options(add = TRUE, display = "none", delta = NA, eval.grid = FALSE, panel = FALSE,
                     positive = FALSE, rugplot = FALSE)
