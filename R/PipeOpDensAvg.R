...
#' @name mlr_pipeops_densavg
#'
#' @description
#' Perform (weighted) prediction averaging from density estimation [PredictionDens]s by connecting
#' `PipeOpDensAvg` to multiple [PipeOpLearner][mlr3pipelines::PipeOpLearner] outputs.
#'
...
#' as follows:
#' * `"pdf"` is all a weighted average from the incoming predictions.
...
#' with a [PredictionDens] for inputs and outputs.
#'
#' @section State:
